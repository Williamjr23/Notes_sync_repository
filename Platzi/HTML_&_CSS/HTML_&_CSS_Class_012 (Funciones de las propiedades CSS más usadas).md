...
| outline       | Un término algo desconocido es el esquema de los elementos HTML. Un esquema es una línea(por defecto, de color azúl) que se dibuja alrededor de los elementos y hace que "se destaquen". Lo anterior sucede mucho en elementos como los <input>s y los <button>s. Si no queremos ver esa línea que se dibuja alrededor de los elementos que hace que                                                                                                                                                                                                                                                                          |
